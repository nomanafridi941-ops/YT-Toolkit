      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/contact" element={<SimplePage title="Contact Us" content={<p>If you have any queries, please reach out to us at <strong>support@yttoolkitpro.example</strong>. We usually respond within 24-48 hours.</p>} />} />
